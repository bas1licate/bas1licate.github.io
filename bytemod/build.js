...
["and #","ior #","xor #","negate","negative","plus #", "minus #"].map(x => {let b = Object.assign(qi.createElement("label")); b.append(x,Object.assign(qi.createElement("input"),{type: "radio", name: "op", value: x})); return b}).forEach(x => {l = qi.createElement("li"); l.append(x); stuff.at(-1).append(l)})
