...
["and #","ior #","xor #","negate","negative"].map(
  x => {let b = Object.assign(qi.createElement("label")); b.append(x,Object.assign(qi.createElement("button"),{type: "radio", name: "op", for: x})); return b}
).forEach(x => {l = qi.createElement("li"); l.append(x); stuff.at(-1).append(l)})
